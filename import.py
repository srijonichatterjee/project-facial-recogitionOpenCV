...
while True:
    ...
    # Exit loop when 'p' is pressed  - (addition)
...
#TRAINING
# Function to find encodings of images-converts imgs to rgb returns list of encoded face data
...
path = r'C:\Users\KIIT\Desktop\srijoni project RT\faces'
